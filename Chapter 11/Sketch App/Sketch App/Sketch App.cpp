...
// Sketch App.cpp : Defines the class behaviors for the application.
//
...
CSketchApp::CSketchApp() noexcept
{
	...
	SetAppID(_T("SketchApp.AppID.NoVersion"));
...
BOOL CSketchApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_SketchTYPE,
		RUNTIME_CLASS(CSketchAppDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CSketchAppView));
	if (!pDocTemplate)
		return FALSE;
